...
parser.add_argument("task", type=str, help="set_day (set day for Today), in (inport), out (outport), exp (expired), stock (print stock), inv (inventory at date ...), rev (revenue at date ...), prof (profit at date ...), prod (product over time)")
